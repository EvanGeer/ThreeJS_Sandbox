...
function init() {
  ...
  const pointLight = new THREE.PointLight(0xbbccff, 50);
  camera.add(pointLight);
  scene.add(camera);

  const ambientLight = new THREE.AmbientLight(0xbbffaa, 0.65);
  ...
  controls.addEventListener("change", () => console.log(scene));
